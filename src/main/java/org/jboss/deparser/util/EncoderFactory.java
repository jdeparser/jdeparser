 ...
 */
package org.jboss.deparser.util;
	...
	public static CharsetEncoder createEncoder( String encodin ) {
        ...
        if( cs.getClass().getName().equals("sun.nio.cs.MS1252") ) {
            try {
                ...
                Class<? extends CharsetEncoder> ms1252encoder = (Class<? extends CharsetEncoder>) Class.forName("org.jboss.jdeparser.util.MS1252Encoder");
