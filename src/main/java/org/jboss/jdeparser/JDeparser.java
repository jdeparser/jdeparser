...
import org.jboss.jdeparser.writer.FileCodeWriter;
import org.jboss.jdeparser.writer.ProgressCodeWriter;
 ...
 *
 * <p>
 * Here's your typical JDeparser application.
 *
 * <pre>
 * JDeparser cm = new JDeparser();
 *
 ...
 *
 * <p>
 * Every JDeparser node is always owned by one {@link JDeparser} object
 ...
 * in a top-down fashion. For example, you create a class from {@link JDeparser},
 ...
 * but generally you work with JDeparser in a top-down fashion.
 *
 * Because of this design, most of the JDeparser classes aren't directly instantiable.
 *
 * <h2>Where to go from here?</h2>
 * <p>
 * Most of the time you'd want to populate new type definitions in a {@link JDeparser}.
...
public final class JDeparser {
    ...
    private static boolean getFileSystemCaseSensitivity() {
        try {
            ...
            // wants to override.
            if( System.getProperty("org.jboss.jdeparser.FileSystemCaseSensitive")!=null )
                return true;
        } catch( Exception e ) {}
     ...
     * There is one pool for each JDeparser object.
     * 
     * <p>
    ...
    private class JReferencedClass extends JClass implements JDeclaration {
        ...
        public JPackage _package() {
            ...
            // this type is array
            if (name.indexOf('[') != -1)
                return JDeparser.this._package("");
            ...
            if (idx < 0)
                ...
                return JDeparser.this._package(name.substring(0, idx));
        }
        ...
        public Iterator<JClass> _implements() {
            ...
            return new Iterator<JClass>() {
                ...
                public JClass next() {
                    return JDeparser.this.ref(interfaces[idx++]);
                }
                public void remove() {
        ...
        public JPrimitiveType getPrimitiveType() {
            ...
            if(v!=null)
                return parse(JDeparser.this,v.getName());
            else
                return null;
        }
